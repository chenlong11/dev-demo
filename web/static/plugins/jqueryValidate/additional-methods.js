...
// Same as url, but TLD is optional
     ...
     */
    $.validator.addMethod("telZH", function (value, element) {
        var reg = /^\d{3,4}-?\d{7,9}$/;
...
//联系电话(手机/电话皆可)验证
    $.validator.addMethod("isPhone", function (value, element) {
        var mobile = /^(((13[0-9]{1})|(14[0-9]{1})|(17[0-9]{1})|(15[0-3]{1})|(15[5-9]{1})|(18[0-9]{1}))+\d{8})$/;
        var tel = /^\d{3,4}-?\d{7,9}$/;
    ...
    $.validator.addMethod("IdCard", function (value, element) {
        ...
        for(j=0,len=coefficient.length;j<len;j++){
            sum += coefficient[j]*value[j];
        }
      ...
      /* coefficient.forEach(function (ele,index) {
        ...
        if(checkDigit[remainder]==value[value.length-1]){
